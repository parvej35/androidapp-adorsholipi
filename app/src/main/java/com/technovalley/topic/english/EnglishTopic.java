...
public class EnglishTopic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            ...
            //setTitle(getString(R.string.english));
            setTitle("ইংরেজি পরিচ্ছেদ");
            ...
            layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent i = new Intent(EnglishTopic.this, EnglishAlphabet.class);
                    startActivity(i);
                }
            });
            ...
            layout.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent i = new Intent(EnglishTopic.this, EnglishNumber.class);
                    startActivity(i);
                }
            });
            ...
            layout.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent i = new Intent(EnglishTopic.this, EnglishDay.class);
                    startActivity(i);
                }
            });
            ...
            layout.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent i = new Intent(EnglishTopic.this, EnglishMonth.class);
                    startActivity(i);
                }
            });

            //---------------------------------
            layout = (LinearLayout) findViewById(R.id.layout_english_season_name);
            layout.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent i = new Intent(EnglishTopic.this, EnglishSeason.class);
                    startActivity(i);
                }
            });
