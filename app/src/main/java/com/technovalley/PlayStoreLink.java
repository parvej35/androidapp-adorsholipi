...
public class PlayStoreLink {
    ...
    public void moreApps(Context context) {
        try {
            ...
            try {
                ...
                Toast.makeText(context, R.string.install_google_play_store, Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    public void shareApp(Context context) {
        try {
            ...
            String subject = context.getString(R.string.title);
            ...
            //start sharing via
            context.startActivity(Intent.createChooser(shareIntent, context.getString(R.string.message)));
        } catch (ActivityNotFoundException e) {
            Toast.makeText(context, e.getMessage(), Toast.LENGTH_LONG).show();
        }
    }
